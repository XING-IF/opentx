...
// External Module
  ...
  #if defined(RADIO_T8)
    #define EXTMODULE_RF_SWITCH_GPIO              GPIOE       //天线切换端口
    #define EXTMODULE_RF_SWITCH_GPIO_PIN          GPIO_Pin_8  //天线切换器引脚
    #define EXTMODULE_PWR_GPIO                    GPIOE       //外部射频电源模块
    #define EXTMODULE_PWR_GPIO_PIN                GPIO_Pin_0  //外部射频电源模块
